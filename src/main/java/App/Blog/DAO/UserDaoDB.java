...
public class UserDaoDB implements UserDao {
    ...
    public User createUser(User user) {
        final String INSERT_USER = "INSERT INTO user (username, password, firstName, lastName, email, activated) VALUES (?,?,?,?,?,?)";
        jdbc.update(INSERT_USER, user.getUsername(), user.getPassword(), user.getFirstName(), user.getLastName(), user.getEmail(), user.isActivated());
    ...
    public void updateUser(User user) {
        final String UPDATE_USER = "UPDATE user SET " +
                ...
                "activated = ? " +
                "WHERE userId = ?";
        jdbc.update(UPDATE_USER, user.getUsername(), user.getPassword(), user.getFirstName(), user.getLastName(), user.getEmail(), user.isActivated(), user.getUserId());
