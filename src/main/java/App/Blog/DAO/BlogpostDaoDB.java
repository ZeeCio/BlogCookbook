...
public class BlogpostDaoDB implements BlogpostDao {
    ...
    public Blogpost createBlogpost(Blogpost blogpost) {
        final String INSERT_BLOGPOST = "INSERT INTO blogpost (timePosted, title, type, status, content, userId) VALUES (?,?,?,?,?,?)";
        jdbc.update(INSERT_BLOGPOST, blogpost.getTimePosted(), blogpost.getTitle(), blogpost.getType(), blogpost.getStatus(), blogpost.getContent(), blogpost.getUser().getUserId());
    ...
    public void updateBlogpost(Blogpost blogpost) {
        final String UPDATE_BLOGPOST = "UPDATE blogpost SET " +
                ...
                "userId = ? " +
                "WHERE blogpostId = ?";
        jdbc.update(UPDATE_BLOGPOST, blogpost.getTimePosted(), blogpost.getTitle(), blogpost.getType(), blogpost.getStatus(), blogpost.getContent(), blogpost.getUser().getUserId(), blogpost.getBlogpostId());
